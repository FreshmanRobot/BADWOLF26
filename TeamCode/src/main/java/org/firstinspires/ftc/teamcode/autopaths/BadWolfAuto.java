...
//        }
        ...
        switch (state) {
            ...
            case CLAW_ACTION:
                if (System.currentTimeMillis() >= clawActionStartMs + CLAW_CLOSE_MS) {
                    ...
                    if (clawServo != null) clawServo.setPosition(CLAW_CLOSED_POS); // open
    ...
    public static class Paths {
        ...
        // --- Define poses for DECODE autonomous ---
        ...
        public Paths(Follower follower) {
            ...
            Path2 = follower
                    .pathBuilder()
                    .addPath(
                            new BezierLine(scorePose, goTo1Pose)
                    )
            ...
            Path3 = follower
                    .pathBuilder()
                    .addPath(
                            new BezierLine(goTo1Pose, pickup1Pose)
                    )
            ...
            Path5 = follower
                    .pathBuilder()
                    .addPath(
                            new BezierLine(scorePose, goTo2Pose)
                    )
            ...
            Path6 = follower
                    .pathBuilder()
                    .addPath(
                            new BezierLine(goTo2Pose, pickup2Pose)
                    )
                    //.setLinearHeadingInterpolation(Math.toRadians(180), Math.toRadians(180))
                    .build();
            ...
            Path8 = follower
                    .pathBuilder()
                    .addPath(
                            new BezierLine(scorePose, goTo3Pose)
                    )
                    //.setLinearHeadingInterpolation(Math.toRadians(130), Math.toRadians(180))
                    .build();
            ...
            Path9 = follower
                    .pathBuilder()
                    .addPath(
                            new BezierLine(goTo3Pose, pickup3Pose)
                    )
                    //.setLinearHeadingInterpolation(Math.toRadians(180), Math.toRadians(180))
                    .build();
            ...
            Path11 = follower
                    .pathBuilder()
                    .addPath(
                            new BezierLine(scorePose, new Pose(48, 70))
                    )
